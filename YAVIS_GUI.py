...
CSCI-729 YAVIS-Personal Assistant

This program is the implementation of the components in the GUI.
...
def create_New_Toplevel_1(root, *args, **kwargs):
    """
    The Method to create the container when called by another program
...
def destroy_New_Toplevel_1():
    """
    The method to delete the Container
...
class Container:
    def __init__(self, top=None):
        """
        The method to initialize components in the GUI
        
        :param top: The container (top-level) 
        """
